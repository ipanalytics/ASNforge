...
| Field | Value |
| --- | ---: |
| Build ID | `20260816-040013Z` |
| Profile | `public-safe` |
| Generated | `2026-08-16T04:00:13Z` |
| Quality | `PASS` |
| ASN profiles | 140,493 |
| Named ASN profiles | 121,763 |
| Prefixes | 1,460,794 |
| MMDB inserted prefixes | 1,460,794 |
| MOAS prefixes | 13,738 |
| Private ASN records | 148 |
| Reserved ASN records | 28 |
| Unknown type ASNs | 126,376 |
| Build duration seconds | 80.92 |

## Sources

| Name | URL | Size | SHA256 |
| --- | --- | ---: | --- |
| `afrinic` | [delegated-afrinic-extended-latest](https://ftp.afrinic.net/pub/stats/afrinic/delegated-afrinic-extended-latest) | 988,710 | `b46103302ad6` |
| `apnic` | [delegated-apnic-extended-latest](https://ftp.apnic.net/stats/apnic/delegated-apnic-extended-latest) | 9,197,604 | `942b5d2aed7c` |
| `arin` | [delegated-arin-extended-latest](https://ftp.arin.net/pub/stats/arin/delegated-arin-extended-latest) | 12,754,425 | `f868064ea4f2` |
| `lacnic` | [delegated-lacnic-extended-latest](https://ftp.lacnic.net/pub/stats/lacnic/delegated-lacnic-extended-latest) | 4,546,579 | `ce7d0654b769` |
| `ripe` | [delegated-ripencc-extended-latest](https://ftp.ripe.net/pub/stats/ripencc/delegated-ripencc-extended-latest) | 18,021,074 | `b18504a348c5` |
| `ed2d58969c8c-table.jsonl` | [table.jsonl](https://bgp.tools/table.jsonl) | 75,381,195 | `795ddafc4373` |
| `asn_catalog` | [asns.csv](https://bgp.tools/asns.csv) | 5,553,956 | `f3ebafd637f9` |
...
| `asn_signals` | [asn-signals.csv](https://raw.githubusercontent.com/ipanalytics/ASN-Signal-Graph/main/data/current/asn-signals.csv) | 610,531 | `59d6bb3610b6` |

## Artifacts

| Artifact | Size | Records |
| --- | ---: | ---: |
| `asnforge-asn.csv.gz` | 2,858,878 | 140,493 |
| `asnforge-asn.jsonl.gz` | 3,620,391 | 140,493 |
| `asnforge-diff.json` | 224 | - |
| `asnforge-prefixes.csv.gz` | 8,785,639 | 1,460,794 |
| `asnforge-prefixes.jsonl.gz` | 10,754,099 | 1,460,794 |
| `asnforge.mmdb.gz` | 6,133,346 | 1,460,794 |
| `manifest.json` | 3,719 | - |
