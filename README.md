...
| Field | Value |
| --- | ---: |
| Build ID | `20260728-060350Z` |
| Profile | `public-safe` |
| Generated | `2026-07-28T06:03:50Z` |
| Quality | `PASS` |
| ASN profiles | 140,503 |
| Named ASN profiles | 121,439 |
| Prefixes | 1,455,856 |
| MMDB inserted prefixes | 1,455,856 |
| MOAS prefixes | 14,064 |
| Private ASN records | 158 |
| Reserved ASN records | 28 |
| Unknown type ASNs | 126,413 |
...
| --- | --- | ---: | --- |
| `afrinic` | [delegated-afrinic-extended-latest](https://ftp.afrinic.net/pub/stats/afrinic/delegated-afrinic-extended-latest) | 985,142 | `9e81489906cb` |
| `apnic` | [delegated-apnic-extended-latest](https://ftp.apnic.net/stats/apnic/delegated-apnic-extended-latest) | 9,174,408 | `788368cc3407` |
| `arin` | [delegated-arin-extended-latest](https://ftp.arin.net/pub/stats/arin/delegated-arin-extended-latest) | 12,726,886 | `2edb912a617f` |
| `lacnic` | [delegated-lacnic-extended-latest](https://ftp.lacnic.net/pub/stats/lacnic/delegated-lacnic-extended-latest) | 4,537,319 | `c85142abace6` |
| `ripe` | [delegated-ripencc-extended-latest](https://ftp.ripe.net/pub/stats/ripencc/delegated-ripencc-extended-latest) | 18,010,204 | `9287d42901b1` |
| `ed2d58969c8c-table.jsonl` | [table.jsonl](https://bgp.tools/table.jsonl) | 75,157,331 | `5384e04b718a` |
| `asn_catalog` | [asns.csv](https://bgp.tools/asns.csv) | 5,540,183 | `5cc3d194b64f` |
...
| `asn_signals` | [asn-signals.csv](https://raw.githubusercontent.com/ipanalytics/ASN-Signal-Graph/main/data/current/asn-signals.csv) | 607,653 | `1cf83b8c6383` |

## Artifacts

| Artifact | Size | Records |
| --- | ---: | ---: |
| `asnforge-asn.csv.gz` | 2,852,799 | 140,503 |
| `asnforge-asn.jsonl.gz` | 3,611,926 | 140,503 |
| `asnforge-diff.json` | 224 | - |
| `asnforge-prefixes.csv.gz` | 8,834,370 | 1,455,856 |
| `asnforge-prefixes.jsonl.gz` | 10,774,965 | 1,455,856 |
| `asnforge.mmdb.gz` | 6,114,253 | 1,455,856 |
| `manifest.json` | 3,719 | - |
